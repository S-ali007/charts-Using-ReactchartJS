...
function SalesActivitesRightSide() {
  return (
    <div className="max-w-[304px] w-full flex flex-col gap-[24px]  ">
      <div className="flex  justify-end   rounded-[4px] text-blue-700 font-[500px]">
       
        <select
          name="cars"
          id="cars"
          className="max-w-[187px] w-full py-[10px] px-[20px] border-[1px] border-blue-700 rounded-[4px] font-bold"
        >
          <option value="Pick a Date Range">Pick a Date </option>
